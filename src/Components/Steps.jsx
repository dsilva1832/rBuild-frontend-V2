          ...
          <Box sx={{width: '100%'}}>
            ...
            <div>
              ...
              <div className="d-flex justify-content-between">
                {
                  userInput.skills.length>0 ? userInput.skills.map(skills=>(
                    <span className='btn btn-primary d-flex align-items-center
                    justify-content-center'>{skills}<button onClick={()=>removeSkill(skills)} className='btn text-light'>x</button></span>
        ...
        <div>
          <h3>Professional Summary</h3>
            <div className='d-flex row p-3'>
              ...
              defaultValue="Eg: I am a passionate full stack developer..." variant="standard" //value="" 
